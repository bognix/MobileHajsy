...
public class GoogleSignInButtonViewManager extends SimpleViewManager<SignInButton> {
    ...
    protected SignInButton createViewInstance(final ThemedReactContext reactContext) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class).emit("GoogleSignInButtonClicked", null);
            }
        });
        return button;
    }
